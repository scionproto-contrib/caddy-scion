...
replace github.com/quic-go/quic-go => github.com/Anapaya/quic-go v0.57.1-ana.1

replace github.com/caddyserver/caddy/v2 => github.com/JordiSubira/caddy/v2 v2.10.1-0.20251205111322-d54578af20d1
